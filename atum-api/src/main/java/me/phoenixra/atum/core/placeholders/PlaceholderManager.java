...
public class PlaceholderManager {
     ...
     */
    private static final HashMap<AtumPlugin,
    ...
    public static String translatePlaceholders(@NotNull final String text,
        ...
        AtumAPI api = AtumAPI.getInstance();
        for(String textToReplace : findPlaceholdersIn(text)){
            ...
            if(parts.length == 2) {
                AtumPlugin plugin = api.getPluginByName(parts[0]);
     ...
     * @return The placeholders.
     */
    public static Set<RegistrablePlaceholder> getRegisteredPlaceholders(@NotNull final AtumPlugin plugin) {
